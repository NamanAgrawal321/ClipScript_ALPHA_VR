...
# Define the ffmpeg command
    output_file = os.path.realpath("vedio_data")+"/"+name_of_vedio.replace(".mp3",".wav") 
    command = f'ffmpeg -i "{os.path.realpath("vedio_data")+"/"+name_of_vedio}" -ac 1 -ar 16000 "{output_file}"'
    try:
        # Run the command
